...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Bioimpedance bio1 = new Bioimpedance(null, 26.9, 69.9, 35.4, 2.4, 17.6, 48.0, 3.0, 28, user1);
		Bioimpedance bio2 = new Bioimpedance(null, 25.9, 70.0, 35.9, 2.5, 17.5, 48.0, 3.0, 29, user1);
		Bioimpedance bio3 = new Bioimpedance(null, 24.9, 70.9, 36.2, 3.2, 17.2, 48.0, 3.0, 28, user1);

		Bioimpedance bio4 = new Bioimpedance(null, 26.9, 69.9, 35.4, 2.4, 17.6, 48.0, 3.0, 32, user2);
		Bioimpedance bio5 = new Bioimpedance(null, 25.1, 70.8, 36.2, 3.2, 17.2, 48.0, 3.0, 30, user2);
		Bioimpedance bio6 = new Bioimpedance(null, 25.9, 70.0, 35.9, 2.5, 17.5, 48.0, 3.0, 31, user2);

		Bioimpedance bio7 = new Bioimpedance(null, 26.9, 69.9, 35.4, 2.4, 17.6, 48.0, 3.0, 28, user3);
		Bioimpedance bio8 = new Bioimpedance(null, 25.9, 70.0, 35.9, 2.5, 17.5, 48.0, 3.0, 29, user3);
		Bioimpedance bio9 = new Bioimpedance(null, 24.9, 70.9, 36.2, 3.2, 17.2, 48.0, 3.0, 28, user3);
