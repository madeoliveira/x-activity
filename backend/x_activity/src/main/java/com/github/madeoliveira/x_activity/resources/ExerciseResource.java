...
public class ExerciseResource {
	...
	public ResponseEntity<Exercise> insert(@RequestBody @Valid Exercise obj){
	...
	public ResponseEntity<Exercise> update(@PathVariable Long id, @RequestBody @Valid Exercise obj){
